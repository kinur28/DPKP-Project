...
<div class="container">
	<div class="d-flex align-items-center p-3 my-3 text-dark bg-info rounded shadow-sm">
		...
		<h1 class="h3 mb-0 text-dark ms-5 me-5">Pengesahan Gedung : {{$data_gedung->nama_gedung}}</h1>
			  
			
	</div>
	<div class="my-3 p-3 bg-body rounded shadow-sm">
		<div class="col-md-7 mx-auto col-lg-8 mb-3">
			<iframe style="width: 700px; height: 900px;" src="{{$data_pelaksanaan->getPengesahan()}}"></iframe>
		</div>
	</div>
</div>
@stop