...
@section('content')
	<div class="container">
		 ...
		 <div class="my-3 p-3 bg-body rounded shadow-sm">
			  ...
			  <div class="row mx-auto mt-5">
			  		<a href="/Dashboard/data-laporan-gedung/{{$data_gedung->id}}/edit" class="col btn btn-outline-warning"><i class="fas fa-edit"></i> Edit Data Gedung</a>
		  		</div>
			</div>
		</div>
	</div>
	...
	<div class="my-3 p-3 bg-body rounded shadow-sm">
		<div class="col-md-7 mx-auto col-lg-8 mb-3">
			...
			@endif
			<a href="/Dashboard/data-laporan-gedung/{{$data_gedung->pelaksanaanmkkg_id}}/pelaksanaanmkkg" class="btn btn-outline-success">Input & Edit Pelaksanaan MKKG</a>
	...
	<div class="bg-white">
		<a href="/Dashboard/data-laporan-gedung/{{$data_gedung->id}}/delete" class="col btn btn-outline-danger d-flex align-items-center p-3 my-3 rounded shadow-sm text-center" onclick="return confirm('Apakah yakin data akan dihapus?')"><i class="fas fa-trash-alt"></i>  Hapus Data Gedung</a>
	</div>
